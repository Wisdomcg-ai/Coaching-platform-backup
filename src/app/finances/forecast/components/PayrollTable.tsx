...
export default function PayrollTable({ forecast, employees, plLines, onSave, onUpdateForecast, onSavePLLines }: PayrollTableProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Payroll Settings */}
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg border-2 border-blue-200">
        <div
          className="p-6 border-b-2 border-blue-200 bg-white/50 backdrop-blur-sm cursor-pointer hover:bg-white/70 transition-colors"
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-3 text-base bg-white border-2 border-gray-300 rounded-xl shadow-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 hover:border-blue-400 cursor-pointer appearance-none font-medium"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                min="0"
                max="100"
                className="w-full px-4 py-3 text-base bg-white border-2 border-gray-300 rounded-xl shadow-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 hover:border-blue-400 font-medium"
              />
        ...
        <div className="border-t-2 border-blue-200 bg-white/50 backdrop-blur-sm">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-gray-300 bg-gray-50">
                {/* Employee Info Group */}
                <th colSpan={5} className="px-4 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider border-r-2 border-gray-300 bg-blue-50">
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            onClick={addEmployee}
            className="flex items-center gap-2 px-4 py-2 text-sm text-blue-600 hover:text-blue-700 hover:bg-blue-50 font-medium rounded-lg transition-colors"
          >
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr className="bg-blue-50 font-bold border-t-2 border-gray-300">
                <td className="sticky left-0 z-10 bg-blue-50 px-6 py-3 border-r-2 border-gray-300 text-gray-900">
                  Total Payroll Cost
                </td>
                {monthColumns.filter(c => c.isForecast).map((col) => {
