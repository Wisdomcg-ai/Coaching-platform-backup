    ...
    <div className="flex items-center gap-2 min-w-[280px]">
      ...
      <div className="flex-1 min-w-[180px]">
        <select
          ...
          className="w-full px-3 py-2 text-sm font-medium border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white transition-all cursor-pointer hover:border-gray-400"
        >
      ...
      {(currentMethod === 'straight_line' || currentMethod === 'seasonal_pattern') && (
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <input
            ...
            className="w-16 px-2 py-2 text-sm font-semibold border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right transition-all"
            placeholder="0"
            step="0.5"
            min="0"
            max="100"
