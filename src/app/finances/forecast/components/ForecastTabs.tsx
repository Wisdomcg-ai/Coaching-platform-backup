...
export type ForecastTab = 'assumptions' | 'pl' | 'payroll' | 'versions'
...
const tabs: { id: ForecastTab; label: string; icon: typeof Settings }[] = [
  { id: 'assumptions', label: 'Goals & Assumptions', icon: Settings },
