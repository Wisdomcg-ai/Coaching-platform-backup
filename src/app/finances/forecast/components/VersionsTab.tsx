                    ...
                    <div className="flex items-start justify-between">
                      ...
                      {!isSelected && (
                        <button
                          ...
                          className="ml-4 flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-600 bg-white border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
                        >
