        ...
        {goals ? (
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-900">{formatCurrency(goals.revenue)}</p>
            </div>
            <div className="flex gap-4">
              <div className="flex-1">
                <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-1">Gross Profit</p>
                <p className="text-lg font-semibold text-slate-900">{formatCurrency(goals.grossProfit)}</p>
              ...
              <div className="flex-1">
                ...
                <p className="text-lg font-semibold text-slate-900">{formatCurrency(goals.netProfit)}</p>
