...
// Avatar colors for team members (matches Annual Plan)
const AVATAR_COLORS = [
  'bg-blue-500',
  'bg-green-500',
  'bg-purple-500',
...
// Category information for consistent card styling (matches Prioritize page)
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 border-r border-slate-200">
                      <input
                        ...
                        placeholder="$0"
                        className="w-full px-2 py-2 border rounded-md text-sm text-center font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-blue-300 border-gray-300"
                      />
                    </td>
                    <td className="px-4 py-2 border-r border-slate-200">
                      <input
                ...
                return (
                  <tr className="bg-blue-50">
                    <td className="px-4 py-3 text-sm font-medium text-slate-900 border-r border-slate-200">
                      Gross Margin
                      <div className="text-[10px] font-normal text-blue-600">Auto-calculated</div>
                    </td>
                    <td className="px-4 py-3 text-sm text-slate-700 font-medium border-r border-slate-200 text-center">
                      {quarterlyTarget > 0 ? `${quarterlyTarget}%` : '-'}
                    </td>
                    <td className="px-4 py-2 border-r border-slate-200">
                      <div className="px-2 py-2 bg-blue-100 rounded-md text-sm text-center font-medium text-slate-700 border border-blue-200">
